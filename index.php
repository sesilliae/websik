            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                  <li><a class="dropdown-item" href="script/sejarah.php">Sejarah</a></li>
                  <li><a class="dropdown-item" href="script/visimisi.php">Visi Misi</a></li>
                  <li><a class="dropdown-item" href="script/strukturorganisasi.php">Struktur Organisasi</a></li>
                  <li><a class="dropdown-item" href="script/dosen.php">Dosen</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                  <li><a class="dropdown-item" href="script/kurikulum.php">Kurikulum</a></li>
                  <li><a class="dropdown-item" href="script/laboratorium.php">Laboratorium</a></li>
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="script/akreditasi.php">Akreditasi</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Download
              ...
              <li class="nav-item">
               <a class="nav-link" href="script/FAQ.php">FAQ</a>
              </li>
              <li class="nav-item">
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
          <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="image/sikbenner.jpg" class="d-block w-100" style="opacity: 1; display: block;" alt="Selamat Datang">
                <div class="carousel-caption d-none d-md-block">
                 <h2 style="text-align: center; ">Selamat Datang</h2>
                  ...
                  <a class="btn btn-primary center" href="selamatdatang.html" role="button" >Read More</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row ">
              <div class="col-md-4 mb-3">
                  <h2>Berita Terbaru</h2>
                    ...
                    <a href="mataka.html">Selengkapnya</a>
                  </div>
              <div class="col-md-4 mb-3">
                  <h2>Dosen</h2>
                    ...
                    <a href="dosen.html">Selengkapnya</a>
                  </div>
              <div class="col-md-4 mb-3">
                  <h2>Himataska</h2>
